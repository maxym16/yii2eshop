...
<!--переніс всі стилі <link href="css в /assets/AppAsset.php -->
    <!--[if lt IE 9]>-->
<!--переніс всі скрипти <script src="js в /assets/LtAppAsset.php -->
    <!--<![endif]-->       
...
Modal::begin([
    ...
    'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">Продовжити покупки</button>
        <a href="'.Url::to(['cart/view']).'" type="button" class="btn btn-success">Оформити замовлення</a>
