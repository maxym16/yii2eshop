		...
		<div class="row">
			...
			<ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Категорії<i class="fa fa-angle-down"></i></a>
                              ...
                              <li><a href="<?= Url::to(['category/index']) ?>">Список категорій</a></li>
                              <li><a href="<?= Url::to(['category/create']) ?>">Додати категорію</a></li> 
                              </ul>
                            </li> 
                            <li class="dropdown"><a href="#">Товари<i class="fa fa-angle-down"></i></a>
                              <ul role="menu" class="sub-menu">
                              <li><a href="<?= Url::to(['product/index']) ?>">Список товарів</a></li>
                              <li><a href="<?= Url::to(['product/create']) ?>">Додати товар</a></li>
                              </ul>
                            </li> 
			</ul>
			</div>
...
<!--переніс всі скрипти <script src="js в /assets/AppAsset.php -->
<?php $this->endBody() ?>
</body>
</html>
<?php $this->endPage() ?>
